...
A token is used to provide the proof the client has the permission to access private pages or routes, used in the react app. The token itself is issued by the server and stored in local storage.

- [x] What steps can you take in your web apps to keep your data secure?

To keep data secure you can create private routes that are accessible when the correct login credentials are provided.

- [x] Describe how web servers work.

Web Servers Connect to the internet, locate a specific server through a URL and domain and retrieve and provide the information requested.
